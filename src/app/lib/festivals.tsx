...
export type Festival = {
  ...
  type: 'Fireworks' | 'Parade' | 'Illumination' | 'Dance' | 'Other';
...
export const FESTIVALS: Record<string, Festival> = {
  tanabata: {
    ...
    season: 'Summer',
    type: 'Other',
    nearestStation: 'Sendai Station',
    nearestStation_ja: '仙台駅',
  ...
  gion: {
    ...
    season: 'Summer',
    type: 'Parade',
    nearestStation: 'Karasuma Station',
    nearestStation_ja: '烏丸駅',
  ...
  yodogawa: {
    ...
    season: 'Summer',
    type: 'Fireworks',
    nearestStation: 'Juso Station',
    nearestStation_ja: '十三駅',
  ...
  edogawa: {
    ...
    season: 'Summer',
    type: 'Fireworks',
    nearestStation: 'Shinozaki Station',
    nearestStation_ja: '篠崎駅',
  ...
  nagaoka: {
    ...
    season: 'Summer',
    type: 'Fireworks',
    nearestStation: 'Nagaoka Station',
    nearestStation_ja: '長岡駅',
  ...
  akita: {
    ...
    season: 'Summer',
    type: 'Parade',
    nearestStation: 'Akita Station',
    nearestStation_ja: '秋田駅',
  ...
  hakata: {
    ...
    season: 'Summer',
    type: 'Parade',
    nearestStation: 'Gion Station',
    nearestStation_ja: '祇園駅',
  ...
  kumamoto: {
    ...
    season: 'Summer',
    type: 'Dance',
    nearestStation: 'Kumamoto Castle / City Hall Tram Stop',
    nearestStation_ja: '熊本城・市役所前停留場',
  ...
  yosakoi: {
    ...
    season: 'Summer',
    type: 'Dance',
    nearestStation: 'Kochi Station',
    nearestStation_ja: '高知駅',
  ...
  awaodori: {
    ...
    season: 'Summer',
    type: 'Dance',
    nearestStation: 'Tokushima Station',
    nearestStation_ja: '徳島駅',
  ...
  jidai: {
    ...
    season: 'Autumn',
    type: 'Parade',
    nearestStation: 'Demachiyanagi Station',
    nearestStation_ja: '出町柳駅',
  ...
  shoryonagashi: {
    ...
    season: 'Summer',
    type: 'Parade',
    nearestStation: 'Nagasaki Station',
    nearestStation_ja: '長崎駅',
  ...
  kishiwada: {
    ...
    season: 'Autumn',
    type: 'Parade',
    nearestStation: 'Kishiwada Station',
    nearestStation_ja: '岸和田駅',
  ...
  sapporosnow: {
    ...
    season: 'Winter',
    type: 'Illumination',
    nearestStation: 'Odori Station',
    nearestStation_ja: '大通駅',
