            ...
            <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-2xl overflow-hidden border border-neutral-100">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
                        ...
                        <div className="text-right mt-4 md:mt-0">
                            ...
                            <div className="text-lg font-bold bg-white/20 px-4 py-2 rounded-lg backdrop-blur-sm border border-white/10">
                                {new Date(festival.startDate).toLocaleDateString(language === 'ja' ? 'ja-JP' : undefined)} - {new Date(festival.endDate).toLocaleDateString(language === 'ja' ? 'ja-JP' : undefined)}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-8 md:p-12">
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4 border-b-2 border-amber-500 pb-2 inline-block">
                    ...
                    {festival.subitems && festival.subitems.length > 0 && (
                        <section>
                            <h2 className="text-2xl font-bold text-gray-900 mb-6 border-b-2 border-amber-500 pb-2 inline-block">
